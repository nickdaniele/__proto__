...
class Modal extends LitElement {
  ...
  updated() {
    ...
    content.innerHTML = `<h1 id="marked---markdown-parser">Marked - Markdown Parser</h1>
  ...
  render() {
    ...
    return html`
      <div class="${classMap(this.modalClasses)}">
        <div class="mx-2">
          <div
            class="w-custom fixed text-right text-3xl bg-c-white cursor-pointer"
            @click="${() => {
              this.close();
            }}"
          >
          ...
          <div id="content" class="markdown pt-12 overflow-scroll"></div>
        </div>
      </div>
    `;
  }
